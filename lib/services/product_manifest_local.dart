...
/// Offline copy of [GET /api/product/manifest] — keep fields aligned with `api/routes/product.js`.
const String kProductManifestJson = r'''
{
  "version": 1,
  "workflow": [
    {
...
Map<String, dynamic> defaultProductManifestMap() =>
    jsonDecode(kProductManifestJson) as Map<String, dynamic>;
